...
# Generated on: Wed Jul 08 06:50:06 KST 2026 (Tue Jul 07 21:50:06 UTC 2026)
...
set logfile fv/FSM4/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/FSM4 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k FSM4.v
elaborate_design -golden -root {FSM4} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/FSM4/fv_map.v.gz
elaborate_design -revised -root {FSM4}
...
#add_name_alias fv/FSM4/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.FSM4.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.FSM4.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.FSM4.rtl.fv_map.rpt
