...
# Generated on: Mon Aug 03 20:57:04 KST 2026 (Mon Aug 03 11:57:04 UTC 2026)
...
set logfile fv/watch/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/watch -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k watch.v
elaborate_design -golden -root {watch} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/watch/fv_map.v.gz
elaborate_design -revised -root {watch}
...
#add_name_alias fv/watch/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.watch.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.watch.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.watch.rtl.fv_map.rpt
