...
#  Created on Thu Jul  9 06:39:07 2026                
#                                                     
#######################################################
...
create_library_set -name max_timing\
   -timing /home/hah001/Basic_SoC_Implementation/5_APR/1_LIB/slow_vdd1v0_basicCells.lib
create_library_set -name min_timing\
   -timing /home/hah001/Basic_SoC_Implementation/5_APR/1_LIB/fast_vdd1v0_basicCells.lib
...
create_rc_corner -name rccorners\
   -cap_table /home/hah001/Basic_SoC_Implementation/5_APR/4_CAP_TABLE/cln28hpl_1p10m+alrdl_5x2yu2yz_typical.capTbl\
   -pre_route_res 1\
   -post_route_res 1\
   -pre_route_cap 1\
   -post_route_cap 1\
   ...
   -qrc_tech /home/hah001/Basic_SoC_Implementation/5_APR/5_QRC_TECH/gpdk045.tch
...
create_constraint_mode -name sdc_cons\
   -sdc_files\
    /home/hah001/Basic_SoC_Implementation/5_APR/2_CONSTRAINTS/2_TINY_PROJECT/watch/watch_final.sdc
...
connect_glbobal_net VDD -type pg_pin -pin VDD -inst_base_name *
...
route_special -connect core_pin -layer_change_range { Metal1(1) Metal11(11) } -block_pin_target nearest_target -core_pin_target first_after_row_end -allow_jogging 1 -crossover_via_layer_range { Metal1(1) Metal11(11) } -allow_layer_change 1 -target_via_layer_range { Metal1(1) Metal11(11) }
...
set_db check_drc_report watch.drc.rpt
